...
import { COMPANY_EMAIL, COMPANY_PHONE, COMPANY_PHONE_ALT, COMPANY_PHONE_ALT2, COMPANY_ADDRESS, COMPANY_INSTAGRAM, COMPANY_FACEBOOK } from "@/lib/products";
              ...
              <div className="flex flex-col gap-4">
                {[
                  ...
                  },
                  {
                    ...
                    label: `${COMPANY_PHONE} / ${COMPANY_PHONE_ALT} / ${COMPANY_PHONE_ALT2}`,
                    href: `tel:${COMPANY_PHONE}`,
                  },
                  {
                    icon: <><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z" /><circle cx="12" cy="10" r="3" /></>,
                    label: COMPANY_ADDRESS,
                    href: "https://maps.app.goo.gl/RgcfDt2viaCKw4559",
                  },
                  {
                    icon: (
